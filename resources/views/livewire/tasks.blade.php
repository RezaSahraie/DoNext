<div x-data="{ filter: 'all', showModal: false, search: '' }" x-on:task-created.window="showModal = false" class="space-y-6">
    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div class="relative w-full lg:max-w-md">
                <span
                    class="pointer-events-none absolute inset-y-0 start-0 grid w-11 place-items-center text-slate-400">⌕</span>
    ...
    <section
        ...
        <div class="flex items-center justify-between border-b border-slate-200 px-5 py-5 dark:border-slate-800">
            ...
            <button
                class="rounded-xl p-2 text-slate-400 transition hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-slate-800 dark:hover:text-white">⋮</button>
        </div>
            ...
            : 'border-slate-300 text-transparent hover:border-indigo-500 hover:bg-indigo-500 hover:text-white dark:border-slate-600 dark:hover:border-indigo-400 dark:hover:bg-indigo-500' }}">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="flex items-start justify-between gap-4">
                            ...
                            {{-- Actions --}}
                            <button type="button"
                                class="shrink-0 rounded-lg p-1.5 text-slate-300 opacity-0 transition group-hover:opacity-100 hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-slate-700 dark:hover:text-slate-200">
        ...
        <div x-show="showModal" x-transition:enter="transition ease-out duration-150"
            ...
            <div @click.outside="showModal = false"
                ...
                <div class="mb-6 flex items-start justify-between">
                    ...
                    class="grid h-9 w-9 place-items-center rounded-xl bg-slate-100 text-slate-500 dark:bg-slate-800">✕</button> --}}
                </div>
                ...
                <form wire:submit="createTask" class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="description" wire:model="description" rows="4"
                            class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 outline-none focus:border-indigo-500 dark:border-slate-700 dark:bg-slate-900"
                    ...
                    <div class="flex gap-3 pt-2">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            class="flex-1 rounded-xl bg-indigo-600 py-3 text-sm font-bold text-white hover:bg-indigo-700 disabled:opacity-60">
                        ...
                        <button type="button" @click="showModal = false"
                            class="rounded-xl border border-slate-200 px-5 py-3 text-sm font-bold dark:border-slate-700">
                            انصراف
                        </button>
